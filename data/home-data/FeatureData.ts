...
const feature_data: DataType[] = [
...

  {
    ...
    icon: feature3Icon_1,
    title: "Tạo tài khoản",
    desc: "Thật dễ dàng để mở một tài khoản và bắt đầu hành trình của bạn.",
  },
  {
    id: 2,
    page: "home_1_feature_3",
    ...
    desc: "Hoàn thành hồ sơ của bạn với tất cả các thông tin để thu hút sự chú ý của khách hàng.",
  },
  {
    id: 3,
    page: "home_1_feature_3",
    ...
    desc: "Hãy Yêu cầu và nhận được BĐS ưa thích của bạn với tất cả các yêu cầu và thuê được BĐS.",
  },
