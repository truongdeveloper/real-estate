...
const AgencyDetailsArea = ({ data }: any) => {
            ...
            <div className={`info-pack-one mb-80 xl-mb-50 `}>
              <div className="row">
                <div className="col-xl-6 d-flex">
                  ...
                  >
                    <div
                      className={`tag position-absolute text-uppercase ${"bg-white"}`}
                    >
                      {4} Listing
                    </div>
                  </div>
                ...
                <div className="col-xl-6">
                  <div className="ps-xxl-3 pe-xxl-3 pt-40 lg-pt-30 pb-45 lg-pb-10">
                    <h4>{title_2}</h4>
                    <div className="designation fs-16"> {desc_4}</div>
                    <div className="table-responsive">
                      <table className="table">
                        <tbody>
                          <>
                            {table_data_2.map((td, index) => (
                              <tr key={index}>
                                <td>{td.table_td_1} </td>
                                <td>{td.table_td_2} </td>
                              </tr>
