  ...
  return (
    <div className="accordion" id="accordionTwo">
      <div
        ...
        style={{ border: "none", padding: "2rem", borderRadius: "1rem" }}
      >
        <h4 className="accordion-header pb-3">Các thông số của BĐS</h4>
        <div
                ...
                <table className="table table-bordered">
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>{transformPriceToString(item.giaThue)}/tháng</td>
                    </tr>
                    <tr>
                      <td>
