          ...
          <div className="row">
            ...
            <div className="col-xxl-5 col-lg-6 ms-auto">
              <p className="text-white fs-24 m0 lh-lg  wow fadeInRight">
                Chúng tôi sẵn sàng hỗ trợ bạn trong mọi vấn đề bất động sản, từ
                việc tìm kiếm cho đến thực hiện mua bán hoặc cho thuê. Hãy để
                chúng tôi đồng hành cùng bạn trong hành trình tìm kiếm ngôi nhà
                lý tưởng của bạn.
              </p>
            </div>
          </div>
