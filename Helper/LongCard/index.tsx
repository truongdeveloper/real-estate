...
const LongCard = (props: LongCardI) => {
  ...
  return (
    ...
    `}
    >
      <div className="d-flex flex-nowrap layout-one">
        <div
          className={` position-relative z-1 border-20 overflow-hidden`}
          style={{ width: "400px" }}
        >
          <div
            className={
              "position-absolute rounded-1 p-1 tag bg-white rounded-0 text-dark fw-500"
            }
          >
        ...
        <div className="property-info">
          ...
          <div
            className="real-estate-decription"
            dangerouslySetInnerHTML={{ __html: itemPost.noiDung }}
          ></div>
